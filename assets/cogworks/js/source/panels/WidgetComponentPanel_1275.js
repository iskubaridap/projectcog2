define([], function() {
    return [function(require, module, exports) {
        ...
        var WidgetComponentPanel = function(_ComponentPanel) {
            _inherits(WidgetComponentPanel, _ComponentPanel);

            function WidgetComponentPanel() {
                var options = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
                _classCallCheck(this, WidgetComponentPanel);
                _get(Object.getPrototypeOf(WidgetComponentPanel.prototype), "constructor", this).call(this, options);
                this.id = "widget";
                this.name = "Widget";
                this.icon = "view_compact";
                var self = this;
            ...
            _createClass(WidgetComponentPanel, [{
                ...
                value: function updateComponents() {
                    ...
                    try {
                        for (var _iterator = app.framework.getComponentGroups()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            ...
                            var groupObj = this.renderComponentFolder(group);
                            $.each(app.widgets, function(index, value){
        ...
        module.exports = WidgetComponentPanel
    }, {
