        ...
        var PodsComponentPanel = function(_ComponentPanel) {
            ...
            _createClass(PodsComponentPanel, [{
                ...
                value: function updateComponents() {
                    ...
                    try {
                        for (var _iterator = app.podsComponents[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    if(tmp.length > 0)
                    {
                        ...
                        try {
                            for (var _iterator2 = app.podsComponents[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
