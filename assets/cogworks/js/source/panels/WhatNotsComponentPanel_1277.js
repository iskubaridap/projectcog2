define([], function() {
    return [function(require, module, exports) {
        ...
        var WhatNotsComponentPanel = function(_ComponentPanel) {
            _inherits(WhatNotsComponentPanel, _ComponentPanel);

            function WhatNotsComponentPanel() {
                var options = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
                _classCallCheck(this, WhatNotsComponentPanel);
                _get(Object.getPrototypeOf(WhatNotsComponentPanel.prototype), "constructor", this).call(this, options);
                this.id = "whatNots";
                this.name = "What Nots";
                this.icon = "view_quilt";
                var self = this;
            ...
            _createClass(WhatNotsComponentPanel, [{
                key: "updateComponents",
                value: function updateComponents() {
                    var _this = this;
                    var container = this.scrollable.empty();
                    var spinner = $(this.content).find('.spinner');
                    ...
                    try {
                        for (var _iterator = app.framework.getComponentGroups()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            ...
                            $.each(app.what_nots, function(index, value){
                                if((group.name).toLowerCase() == value)
                                {
                                    group.children = app.whatNotsPackages.children;
                                }
                            });
            ...
            return WhatNotsComponentPanel
        }(ComponentPanel);
        module.exports = WhatNotsComponentPanel
    }, {
