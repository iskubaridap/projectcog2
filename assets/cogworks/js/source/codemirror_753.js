    ...
    return [function(require, module, exports) {
        (function(global, factory) {
            ...
            function zeroWidthElement(measure) {
                ...
                var node = zwspSupported ? elt("span", "â€‹") : elt("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px");
                ...
                if (!special.test(text)) {
                    ...
                    while (true) {
                        ...
                        if (m[0] == "\t") {
                            ...
                            txt$1 = content.appendChild(elt("span", m[0] == "\r" ? "â" : "â¤", "cm-invalidchar"));
