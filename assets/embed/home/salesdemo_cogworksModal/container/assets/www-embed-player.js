...
var sa=/&/g,ta=/</g,ua=/>/g,va=/"/g,xa=/'/g,ya=/\x00/g,za=/[\x00&<>"']/;function Aa(a){var b={"&amp;":"&","&lt;":"<","&gt;":">","&quot;":'"'},c;c=l.document.createElement("div");return a.replace(Ba,function(a,e){var f=b[a];if(f)return f;if("#"==e.charAt(0)){var h=Number("0"+e.substr(1));isNaN(h)||(f=String.fromCharCode(h))}f||(c.innerHTML=a+" ",f=c.firstChild.nodeValue.slice(0,-1));return b[a]=f})}
...
function Fa(a,b){for(var c=0,d=qa(String(a)).split("."),e=qa(String(b)).split("."),f=Math.max(d.length,e.length),h=0;0==c&&h<f;h++){var k=d[h]||"",m=e[h]||"",n=RegExp("(\\d*)(\\D*)","g"),Z=RegExp("(\\d*)(\\D*)","g");do{var wa=n.exec(k)||["","",""],Hc=Z.exec(m)||["","",""];if(0==wa[0].length&&0==Hc[0].length)break;c=Ga(0==wa[1].length?0:parseInt(wa[1],10),0==Hc[1].length?0:parseInt(Hc[1],10))||Ga(0==wa[2].length,0==Hc[2].length)||Ga(wa[2],Hc[2])}while(0==c)}return c}
...
y(Yg,O);var Zg=new P("timing-sent",Yg);var $g={vc:!0},ah={ad_at:"ad_type",cpn:"client_playback_nonce",csn:"client_screen_nonce",yt_lt:"load_type",yt_ad:"is_monetized",yt_ad_pr:"preroll_allowed",yt_red:"is_red_subscriber",yt_vis:"is_visible"},bh=["is_monetized","preroll_allowed","is_red_subscriber","is_visible"],ch=w(Xg.clearResourceTimings||Xg.webkitClearResourceTimings||Xg.mozClearResourceTimings||Xg.msClearResourceTimings||Xg.oClearResourceTimings||t,Xg),dh=Xg.mark?w(Xg.mark,Xg):t;Xg.measure&&w(Xg.measure,Xg);
function eh(a){"_"==a[0]||dh(a);var b=fh(),c=ec();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;gh()["tick_"+a]=void 0;$f("csi_on_gel")?(b=hh(),"_start"==a?ig("latencyActionBaselined",{clientActionNonce:b},void 0):ig("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0),a=!0):a=!1;a||(a=!!r("yt.timing.pingSent_")&&!!$f("navigation_only_csi_reset"));if(!a&&(b=G("TIMING_ACTION",void 0),a=fh(),r("yt.timing.ready_")&&b&&a._start&&ih())){b=!0;c=G("TIMING_WAIT",[]);if(c.length)for(var d=
0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&jh()}}
function kh(){var a=lh().info.yt_lt="hot_bg";gh().info_yt_lt=a;if($f("csi_on_gel"))if("yt_lt"in ah){var b={},c=ah.yt_lt;c in bh&&(a=!!a);b[c]=a;a=hh();b.clientActionNonce=a;ig("latencyActionInfo",b)}else cc(Error("Unknown label yt_lt logged with GEL CSI."))}
...
b["all_"+e]=f.join()}delete a[d]}e=!!b.ap;if(f=r("yt.timing.reportbuilder_")){if(f=f(a,b,void 0))mh(f,e),nh(),ch(),oh(!1)}else{var h=G("CSI_SERVICE_NAME","youtube"),f={v:2,s:h,action:G("TIMING_ACTION",void 0)},k=b.srt;delete b.srt;void 0===a.srt&&(k||0===k||(k=Xg.timing||{},k=Math.max(0,k.responseStart-k.navigationStart),isNaN(k)&&b.pt&&(k=b.pt)),k||0===k)&&(b.srt=Math.round(k));if(b.h5jse){var m=window.location.protocol+r("ytplayer.config.assets.js");(m=Xg.getEntriesByName?Xg.getEntriesByName(m)[0]:
null)?b.h5jse=Math.round(b.h5jse-m.responseEnd):delete b.h5jse}a.aft=ih();ph()&&"youtube"==h&&(kh(),h=a.vc,m=a.pbs,delete a.aft,b.aft=Math.round(m-h));for(var n in b)"_"!=n.charAt(0)&&(f[n]=b[n]);a.ps=ec();b={};n=[];for(d in a)"_"!=d.charAt(0)&&(h=Math.round(a[d]-c),$f("enable_negative_ticks")||(h=Math.max(h,0)),b[d]=h,n.push(d+"."+h));f.rt=n.join(",");(a=r("ytdebug.logTiming"))&&a(f,b);$f("navigation_only_csi_reset")||(nh(),ch(),oh(!1));G("EXP_DEFER_CSI_PING")?(qh(),q("yt.timing.deferredPingArgs_",
...
a.b.disable.html5=!d;d||(a.b.args.html5_unavailable="1")}c=!!a.b.disable.html5}b=c?zh(a)?"flash":"unsupported":"html5"}("flash"==b?a.me:"html5"==b?a.ne:a.oe).call(a)}}
...
d.indexOf(">")&&(d=d.replace(ua,"&gt;")),-1!=d.indexOf('"')&&(d=d.replace(va,"&quot;")),-1!=d.indexOf("'")&&(d=d.replace(xa,"&#39;")),-1!=d.indexOf("\x00")&&(d=d.replace(ya,"&#0;")));d=Dc(rb("b/12014412"),'<iframe src="'+d+'"></iframe>');c.innerHTML=Ab(d);a.b.da(1)}
...
V.prototype.$_st=V.prototype.start;V.prototype.$_gspc=V.prototype.ve;V.prototype.$_gsppc=V.prototype.Hc;V.prototype.$_c=V.prototype.contains;V.prototype.$_g=V.prototype.get;V.prototype.$_a=V.prototype.tb;V.prototype.$_un=V.prototype.qb;V.prototype.$_r=V.prototype.remove;V.prototype.$_gs=V.prototype.S;V.prototype.$_gos=V.prototype.Gc;V.prototype.$_s=V.prototype.subscribe;V.prototype.$_ubk=V.prototype.ga;function so(){var a={device:"online",app:"youtube-online"};ej&&dj();ik();to||(to=new Sj,vk()&&(to.b="/api/loungedev"));uo||(uo=r("yt.mdx.remote.deferredProxies_")||[],q("yt.mdx.remote.deferredProxies_",uo,void 0));vo();var b=wo();if(!b){var c=new V(to);q("yt.mdx.remote.screenService_",c,void 0);b=wo();cl(c,function(a){a?xo()&&vl(xo(),"YouTube TV"):c.subscribe("onlineScreenChange",function(){J("yt-remote-receiver-availability-change")})},!(!a||!a.loadCastApiSetupScript))}if(a&&!r("yt.mdx.remote.initialized_")){q("yt.mdx.remote.initialized_",
!0,void 0);
...
y(Fp,O);function Gp(a,b,c,d){O.call(this,1,arguments);this.b=b;this.g=c||null;this.f=d||null}
...
function cq(a){var b=a.f,c=a.b.subscriptionId;b&&c&&Q(gi,new Zh(b,c,a.b.channelInfo))}
...
q("yt.logging.errors.log",function(a,b,c,d,e){c={name:c||G("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),version:d||G("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0)};e=window&&window.yterr||e;if(a&&e&&!(5<=Vd)){e=a.stacktrace;d=a.columnNumber;var f=r("window.location.href");if(v(a))a={message:a,name:"Unknown error",lineNumber:"Not available",fileName:f,stack:"Not available"};else{var h,k,m=!1;try{h=a.lineNumber||a.Re||"Not available"}catch(wa){h="Not available",m=!0}try{k=a.fileName||a.filename||a.sourceURL||
l.$googDebugFname||f}catch(wa){k="Not available",m=!0}a=!m&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:k,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(d)||(h=h+":"+d);if(!(Ud[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){b={Qb:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:h,level:b||"ERROR"},J:{url:G("PAGE_NAME",
