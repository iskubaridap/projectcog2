...
function cogProjectUpdateCtrl($rootScope, $scope, $element, $state, $http, cogProject, SweetAlert)
{
    var self = this;
...
cogProjectUpdate.controller('cogProjectUpdateCtrl', cogProjectUpdateCtrl);